...
It is organized from the lowest level to the highest level:
    ...
    The lowest level: layer 1 which is for transmission on physical 
	layers with electrical impulse, light or radio signal
...
What is the OSI model?
	...
	functions of a telecommunication system with a strong regard for their 
